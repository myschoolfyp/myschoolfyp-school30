    ...
    <div className="profileContainer p-6 bg-gray-50">
      ...
      {userType === "Admin" && (
        <div className="flex justify-center mt-6 space-x-4">
          <button className="btn bg-[#0F6466] text-white font-semibold py-2 px-4 rounded hover:bg-[#0D4B4C] transition duration-200 shadow-lg" onClick={handleShowStudents}>Students</button>
          <button className="btn bg-[#0F6466] text-white font-semibold py-2 px-4 rounded hover:bg-[#0D4B4C] transition duration-200 shadow-lg" onClick={handleShowTeachers}>Teachers</button>
          <button className="btn bg-[#0F6466] text-white font-semibold py-2 px-4 rounded hover:bg-[#0D4B4C] transition duration-200 shadow-lg" onClick={handleShowAdmins}>Admins</button>
        </div>
      )}
